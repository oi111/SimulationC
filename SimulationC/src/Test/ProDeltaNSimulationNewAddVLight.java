...
public class ProDeltaNSimulationNewAddVLight {
	...
	public static void main(String[] args) {
		...
		double v = 1e-4;
		double x = 2e-5;
		double time = 1e-5;// 1e-4;
		double dk = 2e-9;
		double alpha = 1000;
		int num = 2;
		int t = 50000;
		int nn = 251;
		// for (int i = 0; i < Input.Data2.b.length; i++)
		// System.out.println(Input.Data2.a[i]);

		// pds.process(30, 400, 1000, 30, 10, 0.01, 0.00005, 0.00000000045,
		// 8000000, 401, 2, 0.0001, 100000, 4000, 50,
		// 1000, 0.00001, 1);
		// pds.process(30, 400, 1000, 30, 10, 0.0008, 0.00005, 0.0000000009,
		// 5000000, 201, 2, 0.001, 100000, 14000, 50,
		// 4000, 0.0000012, 1);
		// pds.process(30, 400, 500, 30, 10, 0.00001, 0.00005, 0.00000017,
		// 2000000, 101, 2, 0.8, 0.01, 10, 100000, 2500,
		// 50, 5000, 0.001, 1.3);
