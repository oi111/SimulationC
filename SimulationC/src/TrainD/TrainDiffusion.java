...
public class TrainDiffusion {
	...
	public static void main(String[] args) {
		...
		TrainDiffusion t = new TrainDiffusion();
	...
	void init() {
		...
		output.setFileName("TrainDiffusion.txt");
		output.openFile();
	}
	...
	void process(double alphad, double alphain, double alphak, double alphaout, double cc, double deltat, double deltax,
		...
		for (int i = 0; i < zz; i++) {
			SimulationForTrainDiffusion p = new SimulationForTrainDiffusion();
